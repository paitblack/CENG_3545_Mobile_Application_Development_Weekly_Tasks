...
public class MainActivity extends AppCompatActivity implements fragment_note.OnNoteListInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!displayingEditor){
            ...
            ft.add(R.id.container, fragment_note.newInstance(notes));
            ft.commit();
        }
        else{
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
    ...
    @Override
    public void onNotesSelected(Note note) {
